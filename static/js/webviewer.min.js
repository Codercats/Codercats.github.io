...
viewerElement);var iframeWindow=viewerElement.querySelector("iframe").contentWindow;viewerElement.addEventListener("ready",function(){try{var Tools=iframeWindow.Tools;var instance=wv.getInstance();resolve(Utils.extend({},instance,{Tools:Tools,Annotations:iframeWindow.Annotations,CoreControls:iframeWindow.CoreControls,PartRetrievers:iframeWindow.CoreControls.PartRetrievers,Actions:iframeWindow.Actions,PDFNet:iframeWindow.PDFNet,annotManager:instance.docViewer.getAnnotationManager(),docViewer:instance.docViewer}))}catch(e){reject("Viewer is on a different domain, the promise from WebViewer function is rejected and API functions will not work because of cross domain permissions. See https://pdftron.com/kb_cross_origin for more information.")}})})};
